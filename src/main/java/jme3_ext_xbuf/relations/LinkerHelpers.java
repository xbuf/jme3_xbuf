...
public class LinkerHelpers{
	public static <T> T getRef1(MergeData data, Class<T> as) {
		return getRef(false,data,as);
	}

	public static <T> T getRef2(MergeData data, Class<T> as) {
		return getRef(true,data,as); 
	}

	@SuppressWarnings("unchecked")
	private static <T> T getRef(boolean id, MergeData data, Class<T> as) {
	...
	public static Geometry getGeometry1(MergeData data) {
		return getGeometry(false,data);
	}

	public static Geometry getGeometry2(MergeData data) {
		return getGeometry(true,data);
	}

	private static Geometry getGeometry(boolean id, MergeData data) {
